...
<div class="max-w-3xl mx-auto">
    ...
    @if(session('success'))
        <div class="mb-6 bg-green-50 border border-green-200 text-green-800 rounded-xl px-5 py-4 text-sm font-medium">
            {{ session('success') }}
        </div>
    @endif
    ...
    <div class="space-y-6">
        ...
        {{-- Newsletter --}}
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <h2 class="text-xl font-bold text-gray-900 mb-2">Newsletter</h2>
