...
<div class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false, loading: false }">
    <div class="max-w-md w-full">
        <!-- Logo/Title -->
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-1">Connexion</h1>
            <p class="text-sm text-gray-600">Accédez à votre espace</p>
        </div>
